...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="top-navbar-right ms-auto">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item dropdown dropdown-user-setting">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="{{asset('#')}}" data-bs-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{asset('pages-user-profile.html')}}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{asset('index2.html')}}">
                                        <div class="d-flex align-items-center">
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{asset('authentication-signup-with-header-footer.html')}}">
                                        <div class="d-flex align-items-center">
                        ...
                        <li class="nav-item dropdown dropdown-large">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <div class="row row-cols-3 gx-2">
                                    <div class="col">
                                        <a href="{{asset('ecommerce-orders.html')}}">
                                    ...
                                    <div class="col">
                                        <a href="{{asset('ecommerce-products-grid.html')}}">
                                            <div class="apps p-2 radius-10 text-center">
                                    ...
                                    <div class="col">
                                        <a href="{{asset('component-media-object.html')}}">
                                            <div class="apps p-2 radius-10 text-center">
                                    ...
                                    <div class="col">
                                        <a href="{{asset('ecommerce-orders-detail.html')}}">
                                            <div class="apps p-2 radius-10 text-center">
        ...
        <a href="{{asset('javaScript:;')}}" class="back-to-top"><i class='bx bxs-up-arrow-alt'></i></a>
